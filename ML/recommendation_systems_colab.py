...
model = build_model(ratings, embedding_dim=35, init_stddev=0.3)
...
def compute_scores(query_embedding, item_embeddings, measure=DOT):
  ...
  # scores =
  # ============================================================================
  dot_prod = np.dot(query_embedding, item_embeddings)
  if measure is DOT:
    scores = dot_prod
  else
    scores = (dot_prod/(np.linalg.norm(query_embedding)*np.linalg.norm(item_embeddings)))
  return scores
...
movie_neighbors(model, "Shawshank Redemption, The", DOT)
movie_neighbors(model, "Shawshank Redemption, The", COSINE)
...
movie_neighbors(reg_model, "Shawshank Redemption, The", DOT)
movie_neighbors(reg_model, "Shawshank Redemption, The", COSINE)
